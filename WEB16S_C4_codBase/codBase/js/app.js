...
function igual () {
  ...
  if ((la_operadores_nivel_1.length > 0) || (la_operadores_nivel_2.length > 0 ) || (la_operadores_nivel_3.length > 0)) {

    if ((la_operadores_nivel_1.length == 1) && (la_valor_previo.length == 1) ) {
      ls_cadena = ls_cadena + la_operadores_nivel_1[0] + la_valor_previo[0];
    }

    if ((la_operadores_nivel_2.length == 1) && (la_valor_previo.length == 1) ) {
      ls_cadena = ls_cadena + la_operadores_nivel_2[0] + la_valor_previo[0];
    }

    if ((la_operadores_nivel_3.length == 1) && (la_valor_previo.length == 1) ) {
      ls_cadena = ls_cadena + la_operadores_nivel_3[0] + la_valor_previo[0];
    }
    ...
    ls_cadena = operacionNivel (pila, la_orden_indices_niv1, la_orden_indices_nivel_1, la_orden_operadores_niv1, la_orden_operadores_nivel_1, la_valor_previo, 1, ls_cadena) ;
    ...
    ls_cadena = operacionNivel (pila, la_orden_indices_niv2, la_orden_indices_nivel_2, la_orden_operadores_niv2, la_orden_operadores_nivel_2, la_valor_previo, 2, ls_cadena) ;
    ...
    ls_cadena = operacionNivel (pila, la_orden_indices_niv3, la_orden_indices_nivel_3, la_orden_operadores_niv3, la_orden_operadores_nivel_3, la_valor_previo, 3, ls_cadena) ;
...
function operacionNivel (pila, aa_orden_indices, aa_orden_indices_nivel, aa_orden_operadores, aa_orden_operadores_nivel, aa_valor_previo, an_nivel, as_cadena_operacion) {
  var li_k = 0;
  var li_l = 0;
  var li_m = 0;
  var li_n = 0;
  ...
  for (var li_i = 0; li_i < aa_orden_indices.length; li_i++) {
    for (var li_j = 0; li_j < aa_orden_indices_nivel.length; li_j++) {
      ...
      if (aa_orden_indices[li_i] == aa_orden_indices_nivel[li_j]) {
        ...
        aa_valor_previo[0] = ln_resultado ;
